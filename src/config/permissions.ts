...
const RESOURCE_DEFINITIONS = [
  ...
  { key: 'teams', actions: ['read', 'create', 'update', 'delete', 'manage'], category: 'settings' as const },
  ...
  { key: 'message_templates', actions: ['read', 'create', 'update', 'delete', 'manage'], category: 'settings' as const },
  { key: 'macros', actions: ['read', 'create', 'update', 'delete', 'execute', 'manage'], category: 'settings' as const },
